 ...
 * @mode:   implements two different modes for CAPSLOCK
 */
struct usb_kbd {
...
static int usb_kbd_event(struct input_dev *dev, unsigned int type, unsigned int code, int value){
    ...
    struct usb_kbd *kbd = input_get_drvdata(dev);
        /*******************************************************/
        printk(KERN_ALERT "Inside usb_kbd_event\n");
        /*******************************************************/
    if (type != EV_LED)
        return -1;
    ...
    if(kbd->newleds == 0x01 && kbd->mode == 1) {
        printk(KERN_ALERT "MODE1 --->>> MODE2");
        kbd->newleds = 0x03;
        kbd->mode = 2;
    } else if(kbd->newleds == 0x00 && kbd->mode == 2) {
        printk(KERN_ALERT "MODE2 --->>> MODE1");
        kbd->newleds = 0x00; 
        kbd->mode = 1;
...
static void usb_kbd_led(struct urb *urb){
    ...
    /**********************************************************/
    printk(KERN_ALERT "Inside usb_kbd_led");
    /**********************************************************/
...
static int usb_kbd_open(struct input_dev *dev){
    ...
    /******************************************************/
    printk(KERN_ALERT "Inside usb_kbd_open");
    /******************************************************/
...
static void usb_kbd_close(struct input_dev *dev){
    struct usb_kbd *kbd = input_get_drvdata(dev);
    /******************************************************/
    printk(KERN_ALERT "Inside usb_kbd_close");
    /******************************************************/
...
static int usb_kbd_probe(struct usb_interface *iface, const struct usb_device_id *id){
    ...
    /************************************************************/
    printk(KERN_ALERT "Inside usb_kbd_probe");
    /************************************************************/
...
static void usb_kbd_disconnect(struct usb_interface *intf){
    ...
    /**********************************************************/
    printk(KERN_ALERT "Inside usb_kbd_disconnect");
    /**********************************************************/
